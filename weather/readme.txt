...
timeZones.txt            : country, timezoneId, gmt offset on 1st of January, dst offset to gmt on 1st of July (of the current year), rawOffset without DST
...
The corresponding admin feature is found with the same country and adminX codes and the respective feature code ADMx.
